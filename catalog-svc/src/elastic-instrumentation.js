  ...
  trace: {
    getTracer: () => ({
      startActiveSpan: (name, options, callback) => {
        ...
        // Add setAttribute method for OTel compatibility
    ...
    getActiveSpan: () => {
      ...
      if (!activeSpan.setAttribute) {
        activeSpan.setAttribute = (key, value) => {
          if (activeSpan.addLabels) {
            const labels = {};
            labels[key] = value;
            activeSpan.addLabels(labels);
          } else if (activeSpan.setLabel) {
            activeSpan.setLabel(key, value);
          }
          return activeSpan; // For method chaining
        };
      }
